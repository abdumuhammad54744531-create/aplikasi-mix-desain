...
class CompleteJmdReportDemoSeeder extends Seeder
{
    ...
    private function aggregateTests(Project $project, array $sources, User $user): void
    {
        $fine = [
            ...
            'silt' => [['dry_before' => 500, 'dry_after' => 489.5], ['dry_before' => 500, 'dry_after' => 489.7]],
        ...
        $coarse = [
            ...
            'silt' => [['dry_before' => 1000, 'dry_after' => 998.6], ['dry_before' => 1000, 'dry_after' => 998.8]],
    ...
    private function workflows(Project $project, User $user): void
    {
        ...
        $combinedInput = [...$input, 'combined_mode' => 1, 'combined_fine_percent' => 42, 'combined_coarse_percent' => 58, 'combined_deviation' => 0, 'gradation_max_size' => 20, 'gradation_curve' => 5];
        $combinedMix = app(MixDesign2012Calculator::class)->calculate($combinedInput);
        $this->workflow($project, $user, 'mix-design-2012-combined', 'MD12G-DEMO-001', $combinedInput, $combinedMix, '2026-07-25');
        ...
        $trialFactor = $mix['trial_batch_volume_liter'] / 1000;
        $this->workflow($project, $user, 'trial-mix', 'TRI-DEMO-001', ['trial_volume' => $mix['trial_volume_liter'], 'waste' => 10, 'cement_m3' => $mix['cement'], 'water_m3' => $mix['water_added'], 'fine_m3' => $mix['fine_field'], 'coarse_m3' => $mix['coarse_field']], ['Semen (kg)' => $mix['trial_cement'], 'Air (kg)' => $mix['trial_water'], 'Pasir (kg)' => $mix['trial_fine'], 'Kerikil (kg)' => $mix['trial_coarse'], 'Faktor volume' => $trialFactor], '2026-07-26');
