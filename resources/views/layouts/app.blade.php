...
<a class="nav-link {{request()->routeIs('material-results.*')?'active':''}}" href="{{route('material-results.index')}}"><i class="bi bi-folder2-open me-2"></i>Hasil Pengujian</a>
